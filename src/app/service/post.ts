 ...
 * @LastEditTime: 2025-11-09 18:57:43
...
export const submitTrack = <T = Record<string, any>>(data: T, config?: Partial<CustomAxiosRequestConfig>) =>
  post<T, Post>('/submitTrack', data, config);
